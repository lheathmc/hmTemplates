        ...
        refresh: function () {
            ...
            if (!this.baseHost) {
                if (this.width != null && this.width.toString().indexOf("px") != -1) {
                    this.element.style.width = 2 + parseInt(this.width) + 'px';
                }
                else if (this.width != undefined && !isNaN(this.width)) {
                    this.element.style.width = 2+this.width + 'px';
                }
                else {
                ...
                if (this.height != null && this.height.toString().indexOf("px") != -1) {
                    this.element.style.height = 2+parseInt(this.height);
                }
                else if (this.height != undefined && !isNaN(this.height)) {
                    this.element.style.height = 2 + this.height + 'px';
                }
                else {
                ...
                if (this.width != null && this.width.toString().indexOf("px") != -1) {
                    this.baseElement.style.width = 2 + parseInt(this.width) + 'px';
                }
                else if (this.width != undefined && !isNaN(this.width)) {
                    this.baseElement.style.width = 2 + this.width + 'px';
                }

                if (this.height != null && this.height.toString().indexOf("px") != -1) {
                    this.baseElement.style.height = 2 + parseInt(this.height);
                }
                else if (this.height != undefined && !isNaN(this.height)) {
                    this.baseElement.style.height = 2 + this.height + 'px';
                };
                var that = this,
