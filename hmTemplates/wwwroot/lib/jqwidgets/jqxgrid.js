/**** IMPORTANT : Changes are made by SRG (Search as "SRG CODE")  ****/
...
(function ($) {
    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        createInstance: function (args) {
            ...
            that.isNestedGrid = that.host.parent() ? that.host.parent().css('z-index') == 99 : false;
        ...
        _initmenu: function () {
            ...
            if (this.host.jqxMenu) {
                ...
                this.gridmenu = $('<div id="gridmenu' + this.element.id + '" style="z-index: 99;"></div>');
                ...
                this.gridmenu.jqxMenu({ popupZIndex: 800, width: stringwidth, height: itemsheight, autoCloseOnClick: closeonclick, autoOpenPopup: false, mode: 'popup', theme: this.theme, animationShowDuration: 0, animationHideDuration: 0, animationShowDelay: 0 });
                if (this.filterable) {
        ...
        setcellvalue: function (row, datafield, value, refresh, sync, bSrgApply) {  // SRG CODE (Added a parameter bSrgApply)
            if (row == null || datafield == null)
                return false;
            ...
            var hasfilter = false;
            if (this.filterable && this._initfilterpanel && this.dataview.filters.length && !bSrgApply) { // SRG CODE
                hasfilter = true;
            }
            if (this.virtualmode) {
                this._pagescache = new Array();
            ...
            if (this.sortcolumn && this.dataview.sortby && !this._updating && !bSrgApply) { // SRG CODE
            ...
            if (refresh == true || refresh == undefined) {
                ...
                else if (this.sortcolumn && !hasgroups && !bSrgApply) {  // SRG CODE
                    if (this.autoheight || this.autorowheight) this.prerenderrequired = true;
        ...
        // SRG CODE (Added a new function)
        SRGsetcellvalue: function (m, D, F) {
            return this.setcellvalue(m, D, F, undefined, undefined, true);
        },
        ...
        _initializeColumns: function () {
            ...
            if (this.rowdetails && this.showrowdetailscolumn) {
                ...
                column.visibleindex = visibleindex++;
                column.width = me.groupindentwidth;
                column.width = 25; /* SRG CODE (changed the width of rowdetails column[same as select column]) */
                column.pinned = true;
                column.editable = false;
                column.filterable = false;
                column.draggable = false;
    ...
    function jqxGridColumn(owner, data) {
        ...
        this.limitFilter = false, // SRG CODE
        ...
        this._initfields = function (data) {
            if (data != null) {
                ...
                // SRG CODE - START
                if ($.jqx.hasProperty(data, "limitFilter")) {
                    this.limitFilter = $.jqx.get(data, "limitFilter")
                }
                // SRG CODE - END
                ...
                case "tab":
                    {
                        ...
                        postdata["filterGroups"] = JSON.stringify(filtersObj); // SRG Code
