    ...
    $.extend($.jqx._jqxEditor.prototype, {
                                    ...
                                    if (tool.command == "createlink" && el.nodeName.toLowerCase() == "a") {
                                        ...
                                        if (isLink) {
                                            ...
                                            that.linkPopup = $("<div class='jqx-editor-link-popup' contentEditable='false' style='overflow: hidden; white-space: nowrap; padding: 5px; height: 17px; font-size: 12px; color: #222222; background: #F5F5F5; position: absolute; z-index: 9999;'>"
                                               ...
                                               + " - <a style='color:#222222;' href='" + el.href + "'>" + that.localization['Preview'] + "</a>"
                                                ...
                                                if (event.target && event.target.href) {
                                                    ...
                                                    switch (index) {
                                                        ...
                                                        case 2:
                                                            ...
                                                            break;
                                                        case 3:
                                                            var nvlPreview = that.target.href.toLowerCase().indexOf('getfile.aspx') > 0 ? that.target.href.replace('&t=v', '') : that.target.href
                                                            nvlPreview = (nvlPreview.toLowerCase().indexOf('getfile.aspx') > 0) ? nvlPreview + '&t=v' : nvlPreview
                                                            window.open(nvlPreview, "_blank");
                                                            break;
                                                        default:
        ...
        _createLinkAction: function (event, that, tool) {
            ...
            var template = $("<div class='jqx-editor-window jqx-editor-link-window'><div>" + that.localization['Insert Link'] + "</div><div>"
                ...
                + "<tr/>"
                + "<tr>"
                + "<td align='right'></td><td align='left'><button class='btn btn-primary'>Ok</button><button style='margin-left: 5px;' class='btn btn-cancel'>Remove</button><button style='margin-left: 5px;' class='btn btn-cancel'>Cancel</button></td>"
                + "<tr/>"
                + "</table>"
                + "</div></div>");
            ...
            template.jqxWindow({ resizable: false, width: 400, okButton: btnOK, cancelButton: btnCancel, theme: that.theme, isModal: true, position: { center: that.widget } });
